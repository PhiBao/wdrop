...
- Live deployment (Arc mainnet): `https://…` ← set on deploy (Vercel)
- Public repo: `https://github.com/…/wdrop` ← push `wdrop/` as repo root
- Builder profile: `https://github.com/…` / `https://x.com/…`
- Demo video (≤90s): `https://…` ← record per `docs/DEMO.md`
